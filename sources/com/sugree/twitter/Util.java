...
public final class Util {
    ...
    public static String openUrl(String url, String method, Bundle params) throws MalformedURLException, IOException {
        ...
        conn.setRequestProperty("User-Agent", System.getProperties().getProperty("http.agent") + " TwitterAndroidSDK");
        if (!method.equals("GET")) {
    ...
    public static JSONObject parseJson(String response) throws JSONException, TwitterError {
        ...
        if (json.has(C2DMBaseReceiver.EXTRA_ERROR)) {
            ...
            throw new TwitterError(error.getString("message"), error.getString("type"), 0);
        }
        if (json.has("error_code") && json.has("error_msg")) {
            throw new TwitterError(json.getString("error_msg"), MutantMessages.sEmpty, Integer.parseInt(json.getString("error_code")));
        }
        if (json.has("error_code")) {
            throw new TwitterError("request failed", MutantMessages.sEmpty, Integer.parseInt(json.getString("error_code")));
        }
