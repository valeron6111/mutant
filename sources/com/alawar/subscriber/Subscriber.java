...
public class Subscriber implements View.OnClickListener {
    ...
    public Subscriber(String gameName, Activity activity, ViewGroup rootView) {
        ...
        this.mSubmitter = new Submitter(gameName);
        ...
        this.mSubscriberView.setOnKeyListener(new View.OnKeyListener() { // from class: com.alawar.subscriber.Subscriber.1
        ...
        if (this.mEmailEditText != null) {
            this.mEmailEditText.setOnEditorActionListener(new TextView.OnEditorActionListener() { // from class: com.alawar.subscriber.Subscriber.2
    ...
    public void onClick(View v) {
        if (v.getId() == C0019R.id.alawar_subscriber_BackButton) {
            hideView();
        } else if (v.getId() == C0019R.id.alawar_subscriber_ThankButton) {
            hideView();
        } else if (v.getId() == C0019R.id.alawar_subscriber_SubscribeButton) {
            subscribe();
        }
    }
    ...
    private boolean checkCredentials() {
        ...
        return pattern.matcher(this.mEmailEditText.getText().toString()).matches();
    }
    ...
    protected Dialog showDialog(int id) {
        ...
        switch (id) {
            case 1:
                ...
                builder.setPositiveButton(C0019R.string.alawar_subscriber_ok, new DialogInterface.OnClickListener() { // from class: com.alawar.subscriber.Subscriber.3
            ...
            case 2:
                ...
                pdialog.setOnCancelListener(new DialogInterface.OnCancelListener() { // from class: com.alawar.subscriber.Subscriber.4
            ...
            case 3:
                ...
                builder2.setPositiveButton(C0019R.string.alawar_subscriber_ok, new DialogInterface.OnClickListener() { // from class: com.alawar.subscriber.Subscriber.5
                    @Override // android.content.DialogInterface.OnClickListener
                    public void onClick(DialogInterface dialog2, int whichButton) {
                        Subscriber.this.setFlowState(1);
                    }
    ...
    private class SubscribeTask extends AsyncTask<String, Integer, Boolean> {
        ...
        public Boolean doInBackground(String... args) {
            if (Subscriber.this.mSubmitter != null) {
                return Subscriber.this.mSubmitter.subscribe(args[0], args[1]);
            }
            return false;
        }
